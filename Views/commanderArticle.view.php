...
<?php
    ...
    if ($b_etat == 1) {
?>
<form method="post" action="commanderArticle.php/commanderArticleModifier">
<?php
    }
?>
<table id="t_article">
...
<?php
        ...
        if ($b_etat == 1) {
?>
        <td class="centrer"><a href="<?php echo root ?>/commanderArticle.php/commanderArticleSupprimer?id_article=<?php echo $o_produit['id_article']?>">supprimer l'article</a>
<?php
        }
?>
    </tr>
