...
<form method="post" action="commande.php/modifierQuantiteUtilisateur?idUtilisateur=<?php echo $i_idUtilisateur ?>">
<table>
    <tr>
        <th>Produit</th>
        <!--
...
?>
    <tr class="ligne_article<?php echo $i_numLigne ?>">
        ...
        <td class="centrer"><a href="../commande.php/supprimerArticleUtilisateur?idUtilisateur=<?php echo $i_idUtilisateur ?>&id_article=<?php echo $o_produit['id_article']?>">supprimer l'article</a>
    </tr>
<?php
