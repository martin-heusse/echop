...
if ($o_campagne['etat'] == 1) {
    ?>
    <p>Pour démarrer une nouvelle campagne, vous devez d'abord bloquer les commandes pour la campagne courante.</p>
    <?php
} else {
    ?>
...
<p><span>Numéro : </span><?php echo $o_campagne['id'] ?><br/>
    ...
    if ($o_campagne['etat'] == 1) {
        ?>
        <span class="campagne_ouverte2">ouverte</span>
    </p>
    <p><a href="<?php echo root ?>/campagne.php/gererCampagne?etat=0">Bloquer les commandes pour la campagne courante&nbsp;</a>
        <?php
    } else {
        ?>
        <span class="campagne_fermee2">fermée</span>
    </p>
    <p><a href="<?php echo root ?>/campagne.php/gererCampagne?etat=1">Ouvrir les commandes pour la campagne courante&nbsp;</a>
        <?php
    }
    ?>
    |&nbsp;   
    
    <a href="<?php echo root ?>/campagne.php/avertirUtilisateurNouvelleCampagne?"> <img src="<?php echo root ?>/Layouts/images/msg.png" height="17" alt="<?php echo $titre_page ?>" />&nbsp; Avertir par mail les utilisateurs de la nouvelle campagne</a></p>
...
if ($to_oldCampagne == null or $to_oldCampagne == array()) {
    ...
    foreach ($to_oldCampagne as $o_oldCampagne) {
        ...
        <p><span>Début : </span><?php echo $o_oldCampagne['date_debut'] ?><br/>
            ...
            ?>
            <span class="campagne_fermee2">fermée</span><br/>
            <?php
        }
        ?>
