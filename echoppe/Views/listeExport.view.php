<!-- affiche la liste des exports ou imports possibles-->
<div id="retour">
<p><a class="action_navigation" href="<?php echo root ?>">Retour à l'accueil</a></p>
</div>

<!--Exportations-->
<h2 class="titre_menu">Exportation</h2>

    <li><a href="<?php echo root ?>/exportImport.php/exportBD">Exporter toute la base de données</a></li>
