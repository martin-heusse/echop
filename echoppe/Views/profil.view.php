...
<p><span class="form_col">Nom</span><input type="text" name="resetNom" value="<?php echo $s_nom ?>">  </p>
<p><span class="form_col">Prénom</span><input type="text" name="resetPrenom" value="<?php echo $s_prenom ?>">  </p>
